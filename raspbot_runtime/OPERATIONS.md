...
[안전 점검 기록](SAFETY_REVIEW.md)을 먼저 읽고, 첫 실물 시험은 네 바퀴를 띄우고
사람이 지켜보며 진행하세요. 2026-09-02 확인한 SSH 주소는 `.73`이며 아래 `.74`는 이전 접속 예시입니다. 접속할 때 기기를 재확인합니다.
...
맥 브라우저에서 `http://127.0.0.1:8090`을 엽니다. 통합 웹앱은 `frontend/.env.local`의
