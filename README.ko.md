...
> 2026-09-02: 라즈봇 수동 제어와 카메라 서버 연결 코드가 추가되었다. 작업·팔 UI는 시뮬레이션이며 실제 자율주행·팔 자율 작업·적재 센서 연동은 미완성이다. [현재 기능표](README.md), [자율 초안](autonomy/README.md), [안전 점검](chan/SAFETY_REVIEW.md)을 참고한다.
