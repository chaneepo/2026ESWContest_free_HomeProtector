...
> 라즈봇 수동 제어, 카메라 서버 연동과 작업·팔 UI 시뮬레이션을 제공한다. 자율 작업의 의사결정과 상태 전이는 독립 시뮬레이터로 검증한다. [기능 안내](README.md), [자율 작업 시뮬레이터](autonomy/README.md), [안전 점검](chan/SAFETY_REVIEW.md)을 참고한다.
